...
import { ScanEye, Navigation } from 'lucide-react';
...
export function DriftChart() {
    ...
    return (
        <div className="w-full flex flex-col h-full text-[#D6D6D6]">
            ...
            <div className="relative flex-1 min-h-[300px] w-full mt-4 flex items-end justify-between gap-2 border-b-[1.5px] border-[#D6D6D6]/30 pb-4">
            ...
            <div className="flex items-center gap-8 mt-8 border-[1.5px] border-[#D6D6D6]/30 p-4 w-fit">
